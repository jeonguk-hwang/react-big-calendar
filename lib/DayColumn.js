  ...
  function DayColumn() {
    ...
    _this._selectable = function () {
      ...
      if (!node) {
        ...
        _sentry.default.captureException(new Error("[react-big-calendar] DayColumn _selectable node: ".concat(node)));
      }
      ...
      var maybeSelect = function maybeSelect(box) {
        ...
        if (onSelecting) {
          if (localizer.eq(current.startDate, start, 'minutes') && localizer.eq(current.endDate, end, 'minutes') || onSelecting({
            ...
            _sentry.default.captureException(new Error("[react-big-calendar] DayColumn maybeSelect current.startDate: ".concat(current.startDate, ", start: ").concat(start, ", current.endDate: ").concat(current.endDate, ", end: ").concat(end, ", this.props.resource: ").concat(_this.props.resource)));
            return;
          }
        }
