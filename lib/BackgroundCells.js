...
var BackgroundCells = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(BackgroundCells, [{
    ...
    value: function _selectable() {
      ...
      _sentry.default.captureException(new Error("[SENTRY_EVENT] _selectable - node exists: ".concat(!!node)));
      ...
      selector.on('selecting', function (box) {
        ...
        _sentry.default.captureException(new Error("[SENTRY_EVENT] selecting - box: ".concat(box)));
      ...
      selector.on('select', function (bounds) {
        ...
        _sentry.default.captureException(new Error("[SENTRY_EVENT] select - bounds: ".concat(bounds)));
    ...
    value: function _selectSlot(_ref) {
      ...
      _sentry.default.captureException(new Error("[SENTRY_EVENT] _selectSlot - startIdx: ".concat(startIdx, " endIdx: ").concat(endIdx, " action: ").concat(action)));
