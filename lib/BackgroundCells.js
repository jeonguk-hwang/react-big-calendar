...
var BackgroundCells = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(BackgroundCells, [{
    ...
    value: function _selectable() {
      ...
      _sentry.default.captureMessage("[SENTRY_EVENT] _selectable - node exists: ".concat(!!node), 'info');
      _sentry.default.captureException(new Error("테스트 오류"));
      ...
      selector.on('selecting', function (box) {
        ...
        _sentry.default.captureMessage("[SENTRY_EVENT] selecting - box: ".concat(box), 'info');
      ...
      selector.on('select', function (bounds) {
        ...
        _sentry.default.captureMessage("[SENTRY_EVENT] select - bounds: ".concat(bounds), 'info');
    ...
    value: function _selectSlot(_ref) {
      ...
      _sentry.default.captureMessage("[SENTRY_EVENT] _selectSlot - startIdx: ".concat(startIdx, " endIdx: ").concat(endIdx, " action: ").concat(action), 'info');
