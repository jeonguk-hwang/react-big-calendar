  ...
  (0, _createClass2.default)(Selection, [{
    ...
    value: function _handleTerminatingEvent(e) {
      ...
      if (!this._initialEventData) {
        ...
        _sentry.default.captureException(new Error("[SENTRY_EVENT] select - this._initialEventData: ".concat(this._initialEventData)));
        return;
      }
      ...
      if (e.key === 'Escape' || !isWithinValidContainer) {
        ...
        _sentry.default.captureException(new Error("[SENTRY_EVENT] select - e: ".concat(e)));
      ...
      if (click && inRoot) {
        ...
        _sentry.default.captureException(new Error("[SENTRY_EVENT] select - pageX: ".concat(pageX, ", pageY: ").concat(pageY, ", this.container: ").concat(this.container, ", this.container(): ").concat(this.container(), ", e.target: ").concat(e.target, "}")));
    ...
    value: function _handleMoveEvent(e) {
      ...
      if (this.isClick(pageX, pageY) && !old && !(w || h)) {
        ...
        _sentry.default.captureException(new Error("[SENTRY_EVENT] selecting - pageX: ".concat(pageX, ", pageY: ").concat(pageY, ", old: ").concat(old, ", x: ").concat(x, ", y: ").concat(y)));
        return;
      }
      this.selecting = true;
      ...
      if (!old) {
        ...
        _sentry.default.captureException(new Error("[SENTRY_EVENT] selecting - old: ".concat(old)));
